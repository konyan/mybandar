 ...
 */
public class MyAnimateExpandableListView extends ExpandableListView {
    /*
    ...
    public MyAnimateExpandableListView(Context context) {
        super(context);
    }

    public MyAnimateExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyAnimateExpandableListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private MyAnimateExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(MyAnimateExpandableListView parent) {
            this.parent = parent;
        }
